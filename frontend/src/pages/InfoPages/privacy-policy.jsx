...
function PrivacyPolicy() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white text-left px-6">
      ...
      <div className="max-w-3xl prose prose-lg dark:prose-invert">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Student
              Productivity Hub.
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: latitibabu2018@gmail.com</p>
          </li>
          <li>
            <p>By phone number: +251979586697</p>
          </li>
        </ul>
      </div>
    </div>
