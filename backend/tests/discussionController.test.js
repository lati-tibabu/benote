...
describe("Discussion Controllers", () => {
    ...
    describe("readDiscussion", () => {
        ...
        it("should handle not found error", async () => {
            ...
            expect(res.json).toHaveBeenCalledWith({ message: "Discussion not found!" });
        });
    ...
    describe("updateDiscussion", () => {
        it("should update an existing discussion", async () => {
            ...
            expect(res.json).toHaveBeenCalledWith({ id: 1, title: "Updated Discussion" });
        });

        it("should handle not found error during update", async () => {
            const req = { params: { id: 999 }, body: { title: "Updated Discussion" } };
    ...
    describe("deleteDiscussion", () => {
        it("should delete an existing discussion", async () => {
            const req = { params: { id: 1 } };
            const res = { json: jest.fn() };
            const mockDiscussion = { destroy: jest.fn().mockResolvedValue(undefined) };
            discussion.findByPk.mockResolvedValue(mockDiscussion);
            ...
            expect(res.json).toHaveBeenCalledWith({ message: "Discussion successfully deleted!" });
        });
