...
describe('Team Controller Tests', () => {
    ...
    describe('updateTeam', () => {
       it('should update an existing team', async () => {
            const req = { params: {id: 1}, body: { name: 'Updated team name', description: 'Updated team description'}};
            const res = { json: jest.fn() };
       ...
       it('should handle errors during team update', async () => {
            ...
            const mockTeamInstance = { update: jest.fn(()=> {throw error})};
            team.findByPk.mockResolvedValue(mockTeamInstance);
            await teamController.updateTeam(req, res);
    ...
    describe('deleteTeam', () => {
        ...
        it('should delete a team successfully', async () => {
            ...
            const mockTeamInstance = { destroy: jest.fn().mockResolvedValue(undefined) }; // Mock the destroy function
            team.findByPk.mockResolvedValue(mockTeamInstance);
